...
//    lazy var zeroButton = createButtons(text: "0", backgroundColor: .gray, action: #selector(handlePercent))
...
//    }()
    ...
    func setupViews()  {
        ...
        let operation = view.getStack(views: divideButton,multiButton,minusButton,plusButton,equalButton, spacing: 8, distribution: .fillEqually, axis: .vertical)
        ...
        let numberStack3 = view.getStack(views: numberButtons[6],numberButtons[7],numberButtons[8], spacing: 8, distribution: .fillEqually, axis: .horizontal)
         ...
         let numberStack4 = view.getStack(views: zerozButton,dotButton, spacing: 8, distribution: .fill, axis: .horizontal)
...
//       view.stack(numberButtons,UIView())
    ...
    func createButtons(text:String,backgroundColor:UIColor,action:Selector) -> UIButton {
